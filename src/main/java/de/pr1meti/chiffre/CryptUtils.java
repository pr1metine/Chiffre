...
public class CryptUtils {
     ...
     *
     * <p>
     * A <strong>clockwise</strong> shift is synonymous to <em>encryption</em>, a <strong>counter-clockwise</strong>
     * shift to <em>decryption</em>.
     * </p>
     *
     * @param toBeShifted             An individual char of a plain text or an encrypted message (A-Za-z)
     ...
     * @param keyLength When dealing with Vigenère, pass a key length
     * @return A list of maps containing a count of each occurring character
     */
    ...
    /**
     * Finds reoccurring passages inside a usually encrypted message. Useful, when determining a key length of a
     ...
     *
     * <p>
     * Also provides a way to determine a key by shifting the most frequent letters with the letter known to be the most
     * frequent one in the plain text.
     * </p>
     *
     * @param fAInput                    A frequency analysis output of a previous computation
     * @param numberOfReturnedTopLetters Number of most frequent letters of each key position
     * @param keyToShiftWith             Key to shift with. Usually the one which occurs most often in the plain text
     *                                   of an encrypted message.
     * @param clockwiseShiftDirection    Shifting direction. Usually <code>false</code>.
     * @return A List of the most frequent letter for each position. May be shifted to return possible key characters.
     */
